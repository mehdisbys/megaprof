...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            @if(Auth::check() == false)
                <form id="book-a-lesson" accept-charset="UTF-8" action="/reserver-un-cours-guest" method="POST"
                      data-parsley-validate>

                    @else
                        <form id="book-a-lesson" accept-charset="UTF-8" action="/reserver-un-cours" method="POST"
                              data-parsley-validate>
                            ...
                            <div class="col-md-8">
                                ...
                                {!! Form::input('text','mobile', null, ['class' => 'col-md-8 topmargin-sm','id' => 'mobile', 'placeholder' => "Téléphone"]) !!}
                                {!! Form::input('text','addresse', null, ['class' => 'col-md-8 topmargin-sm', 'id' => 'addresse', 'placeholder' => "Votre adresse"]) !!}

                                    {!! Form::input('text','firstname', old('firstname'),
                                    ['class' => 'col-md-8 topmargin-sm', 'id' => 'firstname', 'placeholder' => "Prénom"]) !!}

                                    {!! Form::input('email','email', old('email'),
                                    ['class' => 'col-md-8 topmargin-sm', 'id' => 'email', 'placeholder' => "Email"]) !!}


                                    {!! Form::input('password','password', null,
                ['class' => 'col-md-8 topmargin-sm', 'id' => 'password', 'placeholder' => "Mot de passe"]) !!}
