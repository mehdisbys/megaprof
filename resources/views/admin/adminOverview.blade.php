...
@section('content')
    ...
    <div class="col-md-10 topmargin-lg bottommargin-lg col-md-offset-1" id="content">
        ...
        <h2 class="col-md-12 border1px">
            <a class="col-md-3" href="https://analytics.google.com/analytics/web/"><i class="fa fa-line-chart"></i></a>
            <a class="col-md-3" href="https://www.facebook.com/taelamOfficiel"><i class="fa fa-facebook-square"></i></a>
            <a class="col-md-3" href="https://twitter.com/taelam_officiel"><i class="fa fa-twitter-square"></i></a>
            <a class="col-md-3" href="https://plus.google.com/u/1/115934799609055669898"><i class="fa fa-google-plus-square"></i></a>
        </h2>
    </div>
@endsection