    ...
    <div class="tab-container col-md-8">
        ...
        <ul class="nav nav-pills" role="tablist">
            <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0"
                ...
                <a href="modifier-matiere-{{$advert->id}}" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-137">Matières</a>
            </li>
            ...
            <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-139"
                ...
                <a href="modifier-matiere-{{$advert->id}}" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-139">Niveau</a>
            </li>
            ...
            <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-140"
                ...
                <a href="modifier-matiere-{{$advert->id}}" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-140">Texte</a>
            </li>
            ...
            <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-141"
                ...
                <a href="modifier-matiere-{{$advert->id}}" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-141">Lieux</a>
            </li>
            ...
            <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-142"
                ...
                <a href="modifier-matiere-{{$advert->id}}" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-142">Tarifs</a>
            </li>
            ...
            <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-143"
                ...
                <a href="modifier-matiere-{{$advert->id}}" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-143">Photo</a>
            </li>
        </ul>
    </div>
