...
@section('content')
    ...
    <p>Bonne nouvelle, vous avez reçu une réservation d'annonce récemment !</p>
    ...
    <p> <em>A titre d'information : toute réservation qui n'aura pas reçu de réponse sous 48h sera automatiquement annulée et vous n'aurez pas la possibilité de contacter l'élève.</em></p>
