...
<![endif]--> <!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]> <!--> <html lang="fr"> <!--<![endif]--> 
-->
<html lang="fr">
   <head>
   ...
   <body>
         ...
         <div class="wrapper">
            <div class="header-inner">
               <div class="header-inner-cell header-inner-cell-logo">
                  ...
                  <img src="/temp-images/megaprof.png" srcset="/temp-images/megatprof.png 1x, /temp-images/megatprof@2x.png 2x"  width="170" alt="Cours particuliers avec Megaprof" />
                  </a>
               </div>
               <div class="header-inner-cell header-inner-cell-menu">
                  <button class="header-burger-close"> </button> 
                  <div class="header-menu-inner"> <button class="header-item a-js">S'inscrire</button> 
      ...
      <div class="page">
         <div class="home-search">
            ...
            <form class="home-search-form autocomplete-form" method="post" action="/">
 ...
 <span class="category-marker" style="color:#82b8eb;"> </span>Scolaire</button>
 <button class="home-profs-filter" type="button" data-filter="#ffd267">
 <span class="category-marker" style="color:#ffd267;"> </span>Langues</button>
 <button class="home-profs-filter" type="button" data-filter="#e88f67">
 <span class="category-marker" style="color:#e88f67;"> </span>Musique</button>
 <button class="home-profs-filter" type="button" data-filter="#8743d1">
 <span class="category-marker" style="color:#8743d1;"> </span>Sports</button>
 <button class="home-profs-filter" type="button" data-filter="#ff328e">
 <span class="category-marker" style="color:#ff328e;"> </span>Art & loisirs</button>
 <button class="home-profs-filter active" type="button"> <span class="category-marker neutral"> </span>Tous</button>
 </div>
                     ...
                     <ul class="filters-items-wrapper">
                        ...
                        <li class="home-profs-item">
                           <a class="home-profs-item-anchor" href="" title="Professeur de Mathématiques à Paris">
                            ...
                            <img class="home-profs-item-img" alt="Professeur de Mathématiques à Paris" src="/temp-images/professeur.jpg" /> 
                        </a> 
                           <div class="home-profs-item-description">
                              <div class="home-profs-item-name">Professeur Name</div>
                              <div class="home-profs-item-subject">
<span class="category-marker" style="color:#82b8eb;"> </span> Mathématiques</div>
                           </div>
                        </li>
...
<span class="category-marker" style="color:#82b8eb;"> </span> Mathématiques</div>
               ...
               <p class="align-center">Sélectionnez vous-même et librement vos professeurs parmi plus de 250 000 profils vérifiés et recommandés.</p>
                  ...
                  <div class="cell">
                     <ul>
                        <li>
                           ...
                           <div>
                              <p>Sélectionnez la perle rare parmi une liste d’enseignants vérifiés par nos soins, évalués par leurs anciens élèves et à proximité de chez vous.</p>
                           </div>
                        </li>
                        <li>
                           <span
                           ...
                           <div>
                              <p>Contactez les professeurs directement : présentez-vous, décrivez vos attentes et réservez votre premier cours. Les professeurs confirment et planifient les cours directement avec vous.</p>
                           </div>
                        </li>
                        <li>
                           <span
                           ...
                           <div>
                              <p>Vous ne payez rien tant que vous n’avez pas trouvé votre professeur idéal. Une fois trouvé, Megaprof prélèvera une seule et unique fois 19 euros, jamais avant.</p>
                           </div>
                        </li>
                     </ul>
                  </div>
         ...
         <div
            ...
            <div
               ...
               <p
                  class="align-center">Pour être certain de la qualité de nos professeurs, nous collectons les avis des anciens élèves.</p>
               <ul>
                  <li>
                  ...
                  <li>
                     <div class="component-testimony component-testimony-student">
                        <div class="component-testimony-inner">
                           ...
                           <div class="component-testimony-content">
                              <div class="component-testimony-text">
                                 <p>Michel est une bonne prof, dynamique et très sympathique :) Je recommande </p>
                              </div>
                              <div class="component-testimony-more">
                                 <div class="component-testimony-author">
                                    <span>
         ...
         <div
            ...
            <div
               ...
               <div class="home-share-opinion">
                  ...
                  <blockquote>
                     <p class="home-share-opinion-content">
                        Je me suis inscrit sur Megaprof il y a un peu plus d’un an pour gagner quelques euros par mois car je n’avais pas de travail.<br />
                        <br />
                        Je reçois aujourd'hui vos demandes de cours et j’ai la chance d’avoir des élèves très satisfaits et réguliers. J’ai en général 5 à 10 rendez-vous avec chacun.<br />
                        <br />
               ...
               <p class="align-center">Vous souhaitez donner des cours ? Partagez vos connaissances ou votre passion</p>
            </div>
         </div>
...
Les arts et les loisirs peuvent faire l'objet de cours particuliers.
         ...
         <div class="section-odd home-mag">
            <div class="wrapper">
               ...
               <p class="align-center">
               <p>Le magazine qui aime <strong>les profs</strong>, les élèves, les cours particuliers et le partage de connaissances</p>
               </p>
         ...
         <div
            ...
            <div
               ...
               <div
                  ...
                  <div
                     class="footer-inner-cell footer-inner-cell-confidence" itemtype="http://data-vocabulary.org/Review-aggregate" itemscope="">
                     <h3>Confiance</h3>
                     <ul
                  ...
                  <div class="footer-inner-cell footer-inner-cell-socials">
                     ...
                     <ul class="footer-socials">
                        ...
                        <li>
                           <button class="social-google-plus a-js" data-href="https://plus.google.com/+Megaprof/"> </button>
                        </li>
                     </ul>
                  </div>
                  <div
